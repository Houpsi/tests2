...
/**
 * retrun type of Component4001
 * @return std::string
 */
std::string Component4001::getType() {
    return "Component4001";
}

/**
 * make state for an 4001Component gate
 * @param pin - pin output where we want the result of the gate 4001 (useless here bc one output)
