...
/**
 * retrun type of Component4081
 * @return std::string
 */
std::string Component4081::getType() {
    return "Component4081";
}

/**
 * make state for an 4081Component gate
 * @param pin - pin output where we want the result of the gate 4081 (useless here bc one output)
