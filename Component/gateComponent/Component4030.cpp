...
/**
 * retrun type of Component4030
 * @return std::string
 */
std::string Component4030::getType()
{
    return "Component4030";
}

/**
 * make state for an 4030Component gate
 * @param pin - pin output where we want the result of the gate 4030 (useless here bc one output)
